...
impl PythonMemoryReader {
    ...
    pub fn get_python_type_name_from_object_address(
        ...
        let result = memory_reading_cache.get_python_type_name_from_python_object_address(object_address, || {
    ...
    pub fn read_python_float_object_value(&self, float_object_address: u64) -> Result<f64, &'static str> {
    ...
    pub fn read_active_dictionary_entries_from_dictionary_address(
        ...
        */
        ...
        if number_of_slots > 10_000 {
            return Err("Avoid processing dictionaries with potentially corrupted data"); // Avoid processing dictionaries with potentially corrupted data
        }
